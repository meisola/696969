$(document).ready(function(){
  var config = {
    apiKey: "AIzaSyC056t9T-XpjKMYAUZeDrCzNpg5spFQxfc",
    authDomain: "home-dd450.firebaseapp.com",
    databaseURL: "https://home-dd450.firebaseio.com",
    storageBucket: "home-dd450.appspot.com",
    messagingSenderId: "849893714428"
  };
    ...
    var dbChatRoom = firebase.database().ref().child('chatroom');
      ...
      firebase.auth().onAuthStateChanged(function(user){
        if(user) {
          ...
          dbChatRoom.limitToLast(6).on('child_added', function (snapshot) {
          //GET DATA
          var data = snapshot.val();
